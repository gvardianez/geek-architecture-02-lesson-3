...
public class PostMethodHandler extends MethodHandlerImpl {
    ...
    public PostMethodHandler(MethodHandler handler, ISocketService socketService, IResponseSerializer responseSerializer) {
        super(Method.POST.toString(), handler, socketService, responseSerializer);
    }
